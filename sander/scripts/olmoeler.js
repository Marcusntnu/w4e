...
function install_Beer_DOM() {
    document.getElementById("oel").innerHTML =
        ...
        "</div>" +
        "<img alt='beer' id=\"oelbildeempty\" class=\"noSelect\"  src=\"images/beerempty.png\">"

        +
        "<b id=\"literbrygget\">" + "</b>" + "  liter brygget"

        +
        "<audio src=\"sounds/drinkingSound1.wav\" id=\"drinkingSound1\" ></audio>" +
        "<audio src=\"sounds/drinkingSound2.wav\" id=\"drinkingSound2\" ></audio>" +
        "<audio src=\"sounds/burping.wav\" id=\"burping\" ></audio>";
    Beer_maker();
}
